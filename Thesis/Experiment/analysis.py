...
import pandas as pd
import numpy as np
from Thesis.Experiment.plots import PlotStuff
import matplotlib.pyplot as plt
import scipy.stats as stat
# from statsmodels.stats.anova import AnovaRM
from matplotlib.backends.backend_pdf import PdfPages
from Thesis.Experiment.subjective import Subjective
...
class Analysis():
    ...
    def unpack_data(self):
        ...
        path_robot = "..\\Thesis\\Controller_Design\\data_robot"
        path = "..\\Thesis\\Experiment\\data\\data"
        # path = "first_trial"
    ...
    def save_all_figures(self):
        pp = PdfPages('..\\Thesis\\Experiment\\figures\\experiment.pdf')
        figs = None
        if figs is None:
