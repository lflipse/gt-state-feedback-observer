...
from Lowpassfilter_Biquad import LowPassFilterBiquad
import math
import multiprocessing as mp
import numpy as np

class SensoDriveModule(mp.Process):
    def __init__(self, senso_dict, USB_PORT):
    ...
    def run(self):
        ...
        while not self.exit:
            ...
            if data_available is True:
                ...
                self.states["difference"] = msg["difference"]
    ...
    def map_si_to_sensodrive(self, settings):
        ...
        # print(self.states)
        self.states["torque"] = - self.states["difference"] * 4
        ...
        if settings != None:
            ...
            torque = int(self.states["torque"] * 1000.0)
