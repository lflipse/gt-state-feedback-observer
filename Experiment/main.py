...
from Experiment.SensoDrive.SensoDrive import SensoDriveModule
...
senso_drive = SensoDriveModule(Bw, Kw)

# Time to do an experiment!
experiment_handler = Experiment(senso_drive, Bw, Kw, screen_width, screen_height, controller, controller_type)
