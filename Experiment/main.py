...
import numpy as np
from Controllers.Normalized_Gradient import ControllerNG
...
experiment_handler = Experiment(screen_width, screen_height, robot_controller, human_controller)
experiment_handler.do_experiment(r, N, h)
